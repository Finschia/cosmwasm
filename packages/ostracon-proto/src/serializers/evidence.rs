use crate::ostracon::types::evidence::Sum;
use crate::ostracon::types::Evidence;
...
/// It is a modified copy of the crate::ostracon::types::evidence::Sum struct.
...
pub enum EvidenceVariant {
    ...
    None,
    #[serde(rename = "ostracon/DuplicateVoteEvidence")]
    DuplicateVoteEvidence(crate::ostracon::types::DuplicateVoteEvidence),
    #[serde(rename = "ostracon/LightClientAttackEvidence")]
    LightClientAttackEvidence(crate::ostracon::types::LightClientAttackEvidence),
}
