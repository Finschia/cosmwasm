...
pub struct VoterSet {
    #[prost(message, repeated, tag="1")]
    pub voters: ::prost::alloc::vec::Vec<Validator>,
    #[prost(int64, tag="2")]
...
pub struct VoterParams {
    #[prost(int32, tag="1")]
    pub voter_election_threshold: i32,
    #[prost(int32, tag="2")]
    pub max_tolerable_byzantine_percentage: i32,
}
/// PartsetHeader
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct Header {
    ...
    /// vrf info
    #[prost(int32, tag="1000")]
    pub round: i32,
    #[prost(bytes="vec", tag="1001")]
    pub proof: ::prost::alloc::vec::Vec<u8>,
    /// voters for the current block
    #[prost(bytes="vec", tag="1002")]
    pub voters_hash: ::prost::alloc::vec::Vec<u8>,
}
...
pub struct LightBlock {
    ...
    pub voter_set: ::core::option::Option<VoterSet>,
}
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
