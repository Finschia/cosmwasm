...
pub struct CompositePublicKey {
    ...
    pub sign_key: ::core::option::Option<::prost::alloc::boxed::Box<PublicKey>>,
    #[prost(message, optional, boxed, tag="2")]
    pub vrf_key: ::core::option::Option<::prost::alloc::boxed::Box<PublicKey>>,
}
/// PublicKey defines the keys available for use with Tendermint Validators
#[derive(::serde::Deserialize, ::serde::Serialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct PublicKey {
    #[prost(oneof="public_key::Sum", tags="1, 2, 1000, 1001")]
...
pub mod public_key {
    ...
    pub enum Sum {
        #[prost(bytes, tag="1")]
        #[serde(rename = "ostracon/PubKeyEd25519", with = "crate::serializers::bytes::base64string")]
        Ed25519(::prost::alloc::vec::Vec<u8>),
        #[prost(bytes, tag="2")]
        #[serde(rename = "ostracon/PubKeySecp256k1", with = "crate::serializers::bytes::base64string")]
        Secp256k1(::prost::alloc::vec::Vec<u8>),
        /// *** Ostracon Extended Fields ***
        #[prost(message, tag="1000")]
        Composite(::prost::alloc::boxed::Box<super::CompositePublicKey>),
        #[prost(bytes, tag="1001")]
        Bls12(::prost::alloc::vec::Vec<u8>),
    }
}
