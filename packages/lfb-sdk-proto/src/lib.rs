//! The `lfb-sdk-proto` crate provides access to the LFB SDK proto-defined structs.
//! These are then re-exported in a module structure as close as possible to the proto files.
//!
//! The version strings are intentionally excluded, that way users may specify `lfb-sdk` versions
...
/// The version (commit hash) of the Lfb SDK used when generating this library.
pub const LFB_SDK_VERSION: &str = include_str!("prost/LFB_SDK_COMMIT");

/// Lfb protobuf definitions.
pub mod lfb {
    /// Authentication of accounts and transactions.
    pub mod auth {
        pub mod v1beta1 {
            include!("prost/lfb.auth.v1beta1.rs");
        }
    }
    ...
    pub mod bank {
        pub mod v1beta1 {
            include!("prost/lfb.bank.v1beta1.rs");
        }
    }
    ...
    pub mod base {
        ...
        pub mod abci {
            pub mod v1beta1 {
                include!("prost/lfb.base.abci.v1beta1.rs");
            }
        }
        ...
        pub mod kv {
            pub mod v1beta1 {
                include!("prost/lfb.base.kv.v1beta1.rs");
            }
        }
        ...
        pub mod query {
            pub mod v1beta1 {
                include!("prost/lfb.base.query.v1beta1.rs");
            }
        }
        ...
        pub mod reflection {
            pub mod v1beta1 {
                include!("prost/lfb.base.reflection.v1beta1.rs");
            }
        }

        /// Snapshots containing Ostracon state sync info.
        pub mod snapshots {
            pub mod v1beta1 {
                include!("prost/lfb.base.snapshots.v1beta1.rs");
            }
        }
        ...
        pub mod store {
            pub mod v1beta1 {
                include!("prost/lfb.base.store.v1beta1.rs");
            }
        }

        pub mod v1beta1 {
            include!("prost/lfb.base.v1beta1.rs");
        }

        pub mod ostracon {
            pub mod v1beta1 {
                include!("prost/lfb.base.ostracon.v1beta1.rs");
            }
        }
    }
    ...
    pub mod crisis {
        pub mod v1beta1 {
            include!("prost/lfb.crisis.v1beta1.rs");
        }
    }
    ...
    pub mod crypto {
        ...
        pub mod multisig {
            include!("prost/lfb.crypto.multisig.rs");
            pub mod v1beta1 {
                include!("prost/lfb.crypto.multisig.v1beta1.rs");
            }
        }
        pub mod ed25519 {
            include!("prost/lfb.crypto.ed25519.rs");
        }
        pub mod secp256k1 {
            include!("prost/lfb.crypto.secp256k1.rs");
        }
    }
    ...
    pub mod distribution {
        pub mod v1beta1 {
            include!("prost/lfb.distribution.v1beta1.rs");
        }
    }
    ...
    pub mod evidence {
        pub mod v1beta1 {
            include!("prost/lfb.evidence.v1beta1.rs");
        }
    }
    ...
    pub mod genutil {
        pub mod v1beta1 {
            include!("prost/lfb.genutil.v1beta1.rs");
        }
    }
    ...
    pub mod gov {
        pub mod v1beta1 {
            include!("prost/lfb.gov.v1beta1.rs");
        }
    }
    ...
    pub mod mint {
        pub mod v1beta1 {
            include!("prost/lfb.mint.v1beta1.rs");
        }
    }
    ...
    pub mod params {
        pub mod v1beta1 {
            include!("prost/lfb.params.v1beta1.rs");
        }
    }
    ...
    pub mod slashing {
        pub mod v1beta1 {
            include!("prost/lfb.slashing.v1beta1.rs");
        }
    }
    ...
    pub mod staking {
        pub mod v1beta1 {
            include!("prost/lfb.staking.v1beta1.rs");
        }
    }
    ...
    pub mod tx {
        ...
        pub mod signing {
            pub mod v1beta1 {
                include!("prost/lfb.tx.signing.v1beta1.rs");
            }
        }

        pub mod v1beta1 {
            include!("prost/lfb.tx.v1beta1.rs");
        }
    }
    ...
    pub mod upgrade {
        pub mod v1beta1 {
            include!("prost/lfb.upgrade.v1beta1.rs");
        }
    }
    ...
    pub mod vesting {
        pub mod v1beta1 {
            include!("prost/lfb.vesting.v1beta1.rs");
        }
    }
}
