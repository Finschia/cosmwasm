...
pub struct MsgTransfer {
    ...
    pub token: ::core::option::Option<super::super::super::super::lfb::base::v1beta1::Coin>,
    /// the sender address
    #[prost(string, tag = "4")]
...
pub struct QueryDenomTracesRequest {
    ...
    #[prost(message, optional, tag = "1")]
    pub pagination:
        ::core::option::Option<super::super::super::super::lfb::base::query::v1beta1::PageRequest>,
}
...
pub struct QueryDenomTracesResponse {
    ...
    pub pagination:
        ::core::option::Option<super::super::super::super::lfb::base::query::v1beta1::PageResponse>,
}
