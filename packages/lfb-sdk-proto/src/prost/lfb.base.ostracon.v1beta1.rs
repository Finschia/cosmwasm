...
pub struct GetBlockByHeightResponse {
    #[prost(message, optional, tag = "1")]
    pub block_id: ::core::option::Option<ostracon_proto::types::BlockId>,
    #[prost(message, optional, tag = "2")]
    pub block: ::core::option::Option<ostracon_proto::types::Block>,
}
...
pub struct GetNodeInfoResponse {
    ...
    pub default_node_info:
        ::core::option::Option<ostracon_proto::p2p::DefaultNodeInfo>,
    #[prost(message, optional, tag = "2")]
...
pub mod service_client {
    ...
    use tonic::codegen::*;
    #[doc = " Service defines the gRPC querier service for ostracon queries."]
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_node_info(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/lfb.base.ostracon.v1beta1.Service/GetNodeInfo",
            );
        ...
        pub async fn get_syncing(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/lfb.base.ostracon.v1beta1.Service/GetSyncing",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn get_latest_block(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/lfb.base.ostracon.v1beta1.Service/GetLatestBlock",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn get_block_by_height(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/lfb.base.ostracon.v1beta1.Service/GetBlockByHeight",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn get_latest_validator_set(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/lfb.base.ostracon.v1beta1.Service/GetLatestValidatorSet",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        ) -> Result<tonic::Response<super::GetValidatorSetByHeightResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/lfb.base.ostracon.v1beta1.Service/GetValidatorSetByHeight",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
