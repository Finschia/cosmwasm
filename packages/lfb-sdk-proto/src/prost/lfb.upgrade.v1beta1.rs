...
pub mod query_client {
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn current_plan(
            ...
            let path =
                http::uri::PathAndQuery::from_static("/lfb.upgrade.v1beta1.Query/CurrentPlan");
        ...
        pub async fn applied_plan(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/lfb.upgrade.v1beta1.Query/AppliedPlan");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        ) -> Result<tonic::Response<super::QueryUpgradedConsensusStateResponse>, tonic::Status>
        {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/lfb.upgrade.v1beta1.Query/UpgradedConsensusState",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
