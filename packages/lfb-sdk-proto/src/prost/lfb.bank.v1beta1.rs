...
pub mod query_client {
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn balance(
            ...
            let path = http::uri::PathAndQuery::from_static("/lfb.bank.v1beta1.Query/Balance");
        ...
        pub async fn all_balances(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/lfb.bank.v1beta1.Query/AllBalances");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn total_supply(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/lfb.bank.v1beta1.Query/TotalSupply");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn supply_of(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/lfb.bank.v1beta1.Query/SupplyOf");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn params(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/lfb.bank.v1beta1.Query/Params");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn denom_metadata(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/lfb.bank.v1beta1.Query/DenomMetadata");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn denoms_metadata(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/lfb.bank.v1beta1.Query/DenomsMetadata");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn send(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/lfb.bank.v1beta1.Msg/Send");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn multi_send(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/lfb.bank.v1beta1.Msg/MultiSend");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
