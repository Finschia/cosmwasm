...
pub struct Params {
    ...
    #[prost(uint64, tag = "6")]
    pub valid_sig_block_period: u64,
}
...
pub mod query_client {
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn account(
            ...
            let path = http::uri::PathAndQuery::from_static("/lfb.auth.v1beta1.Query/Account");
        ...
        pub async fn params(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/lfb.auth.v1beta1.Query/Params");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
