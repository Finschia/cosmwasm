...
pub mod query_client {
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn evidence(
            ...
            let path = http::uri::PathAndQuery::from_static("/lfb.evidence.v1beta1.Query/Evidence");
        ...
        pub async fn all_evidence(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/lfb.evidence.v1beta1.Query/AllEvidence");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn submit_evidence(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/lfb.evidence.v1beta1.Msg/SubmitEvidence");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
