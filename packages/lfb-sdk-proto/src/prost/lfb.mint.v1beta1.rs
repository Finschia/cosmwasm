...
pub mod query_client {
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn params(
            ...
            let path = http::uri::PathAndQuery::from_static("/lfb.mint.v1beta1.Query/Params");
        ...
        pub async fn inflation(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/lfb.mint.v1beta1.Query/Inflation");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn annual_provisions(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/lfb.mint.v1beta1.Query/AnnualProvisions");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
