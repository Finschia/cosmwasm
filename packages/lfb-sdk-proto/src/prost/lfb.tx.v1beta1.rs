...
pub mod service_client {
        ...
        <T::ResponseBody as HttpBody>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn simulate(
            ...
            let path = http::uri::PathAndQuery::from_static("/lfb.tx.v1beta1.Service/Simulate");
        ...
        pub async fn get_tx(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/lfb.tx.v1beta1.Service/GetTx");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn broadcast_tx(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/lfb.tx.v1beta1.Service/BroadcastTx");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn get_txs_event(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/lfb.tx.v1beta1.Service/GetTxsEvent");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
