...
pub enum BankMsg {
    ...
    ///
    /// This is translated to a MsgSend in https://github.com/line/lfb-sdk/blob/develop/proto/lfb/bank/v1beta1/tx.proto.
...
#[serde(rename_all = "snake_case")]
pub enum StakingMsg {
    /// This is translated to a MsgDelegate in https://github.com/line/lfb-sdk/blob/develop/proto/lfb/staking/v1beta1/tx.proto.
    /// `delegator_address` is automatically filled with the current contract's address.
    Delegate { validator: HumanAddr, amount: Coin },
    /// This is translated to a MsgUndelegate in https://github.com/line/lfb-sdk/blob/develop/proto/lfb/staking/v1beta1/tx.proto.
    /// `delegator_address` is automatically filled with the current contract's address.
    Undelegate { validator: HumanAddr, amount: Coin },
    /// This is translated to a MsgSetWithdrawAddress in https://github.com/line/lfb-sdk/blob/develop/proto/lfb/distribution/v1beta1/tx.proto.
    /// followed by a MsgWithdrawDelegatorReward in https://github.com/line/lfb-sdk/blob/develop/proto/lfb/distribution/v1beta1/tx.proto.
    /// `delegator_address` is automatically filled with the current contract's address.
    Withdraw {
        validator: HumanAddr,
    ...
    /// This is translated to a MsgBeginRedelegate in https://github.com/line/lfb-sdk/blob/develop/proto/lfb/staking/v1beta1/tx.proto.
    /// `delegator_address` is automatically filled with the current contract's address.
    Redelegate {
...
pub enum WasmMsg {
    ...
    ///
    /// This is translated to a MsgExecuteContract in https://github.com/line/lfb-sdk/blob/develop/x/wasm/internal/types/tx.proto.
    ...
    ///
    /// This is translated to a MsgInstantiateContract in https://github.com/line/lfb-sdk/blob/develop/x/wasm/internal/types/tx.proto.
    /// `sender` is automatically filled with the current contract's address.
    Instantiate {
        code_id: u64,
    ...
    ///
    /// This is translated to a MsgMigrateContract in https://github.com/line/lfb-sdk/blob/develop/x/wasm/internal/types/tx.proto.
    /// `sender` is automatically filled with the current contract's address.
    Migrate {
        contract_addr: HumanAddr,
